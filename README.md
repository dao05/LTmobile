...
7.1. Tài khoản admin :
   admin@rental.com
   admin123
7.2. Tài khoản manager:
   manager@rental.com
   manager123

8. Hình ảnh minh họa hệ thống:
8.1. Giao diện đăng nhập, đăng ký:
...
8.5. Giao diện quản lý khách thuê:
...
8.7. Giao diện quản lý hợp đồng:
...
9. Link video Demo: https://drive.google.com/drive/folders/1aFryKCt8QaQjGD7RUAKf6I72UQw29trC?usp=sharing
